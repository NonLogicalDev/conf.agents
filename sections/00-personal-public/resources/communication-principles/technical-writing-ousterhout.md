...
- Identify who needs to understand, decide, or act.
- Lead with the actual result, problem, question, or request.
...
- **Inferred:** What the evidence suggests but does not prove.
- **Planned:** An action that has not happened.
- **Recommended:** A proposed action and its reason.
...
- Use familiar words, short sentences, concrete verbs, and active voice.
- Explain the problem without criticizing a person's motives or ability.
...
- Consider the time and attention required from each recipient.
- Share a meaningful result, changed blocker, decision, or clear request.
- Do not send updates that repeat unchanged information.
- Keep private notes, internal instructions, and hidden reasoning private.
- Represent the operator's intent without claiming to be the operator.
- Follow the existing public signature and permission instructions.

## Check the result

- Can the reader identify the point immediately?
- Is every important claim supported by the available evidence?
- Are assumptions, unknowns, risks, and tradeoffs clear?
- Does the message add useful information?
- Can the reader understand the situation without seeing the task?
- Is the tone direct, thoughtful, and respectful?
