...
Give the subagent the named skill invocation (`$Skill_Name`) and scenario prompt.
...
A user says:
"<invented analogue that preserves the intended behavior, temptation,
and expected decision without copying a real failure word for word>"
...
- <Shortcut or excuse the agent should avoid.>
...
<Nearby case the repair should still allow (if any).>
