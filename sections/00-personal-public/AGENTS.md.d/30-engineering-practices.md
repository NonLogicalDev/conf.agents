...
- **Frequent checkpoints:** When editing `agent-config`, use [$SVC_Checkpoint]({{%_skills_%}}/SVC_Checkpoint/SKILL.md) after meaningful changes and before risky work or a handoff. Include the task's changes and keep commits local unless the user asks to push.
