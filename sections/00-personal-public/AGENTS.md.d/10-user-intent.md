...
- Treat a human message as steering only when it starts, changes, cancels, or continues work.
- Recognize that casual conversation, acknowledgements, and questions may simply call for a normal reply.
